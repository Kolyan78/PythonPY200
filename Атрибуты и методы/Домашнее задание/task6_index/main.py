...
class LinkedList:
    ...
    def index(self, value: Any):
        ...
        Не смог добавить в параметры начальный и конечный элемент поиска
        Вернее начальный смог добавить start=0,
        а второй хотелось добавить чтобы он по умолчанию был равен текущей длине списка,
        то end=self.len не получается указать в параметрах функции"""
